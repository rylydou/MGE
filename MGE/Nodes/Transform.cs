...
namespace MGE
{
	...
	*/
	public class Transform : Node
	{
		...
		{
			var intAbs = (Microsoft.Xna.Framework.Vector2)absolute;
			Microsoft.Xna.Framework.Vector2.Transform(ref intAbs, ref _invertAbsolute, out var result);
			absolute = intAbs;
			local = result;
		}
		...
		{
			var intLocal = (Microsoft.Xna.Framework.Vector2)local;
			Microsoft.Xna.Framework.Vector2.Transform(ref intLocal, ref _absolute, out var result);
			absolute = result;
		}
		...
		void SetNeedsAbsoluteUpdate()
		{
			...
			foreach (var child in GetNodes<Transform>())
			{
		...
		void UpdateAbsolute()
		{
			if (GetParentNode<Transform>(out var t))
			{

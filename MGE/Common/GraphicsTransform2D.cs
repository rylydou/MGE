...
/// A 2D Transform
/// </summary>
public class GraphicsTransform2D
{
	GraphicsTransform2D? _parent = null;
	bool _dirty = true;
	...
	/// </summary>
	public GraphicsTransform2D? parent
	{
		get => _parent;
	...
	public void SetParent(GraphicsTransform2D? value, bool retainWorldPosition)
	{
		if (_parent != value)
		{

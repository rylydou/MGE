...
namespace MGE.Graphics.Buffers
{
	public class VertexArray : GraphicsObject
	{
		...
		/// </summary>
		public void BindElementBuffer<T>(GraphicsBuffer<T> buffer) where T : struct
		{
			AssertActive();
		...
		// /// </summary>
		// public void BindAttribute<T>(VertexAttrib attribute, GraphicsBuffer<T> buffer) where T : struct
		// {
		...
		// /// The other parameters, namely components, type and normalized are chosen according to the corresponding <see cref="VertexAttribAttribute"/> attribute.
		// /// </summary>
		// public void BindAttribute<T>(VertexAttrib attribute, GraphicsBuffer<T> buffer, int offset) where T : struct
		// {
		...
		// /// The other parameters, namely components, type and normalized are chosen according to the corresponding <see cref="VertexAttribAttribute"/> attribute.
		// /// </summary>
		// public void BindAttribute<T>(VertexAttrib attribute, GraphicsBuffer<T> buffer, int stride, int offset) where T : struct
		// {
		...
		// /// </summary>
		// public void BindAttribute<T>(VertexAttrib attribute, GraphicsBuffer<T> buffer, int stride, int offset, bool normalized) where T : struct
		// {
		...
		// /// Binds the buffer to the given vertex attribute.
		// /// </summary>
		// public void BindAttribute<T>(VertexAttrib attribute, GraphicsBuffer<T> buffer, int components, int stride, int offset) where T : struct
		// {
		...
		// /// Binds the buffer to the given vertex attribute.
		// /// </summary>
		// public void BindAttribute<T>(VertexAttrib attribute, GraphicsBuffer<T> buffer, int components, int stride, int offset, bool normalized) where T : struct
		// {
		...
		// /// Binds the buffer to the given vertex attribute.
		// /// </summary>
		// public void BindAttribute<T>(VertexAttrib attribute, GraphicsBuffer<T> buffer, int components, VertexAttribPointerType type, int stride, int offset, bool normalized) where T : struct
		// {
		...
		/// Binds the buffer to the given vertex attribute.
		/// </summary>
		public void BindAttribute<T>(int index, GraphicsBuffer<T> buffer, int components, VertexAttribPointerType type, int stride, int offset, bool normalized) where T : struct
		{
			AssertActive();
			// bind given buffer

...
namespace MGE.SDL2
{
	public class SDL_System : MGE.System, ISystemOpenGL
	{
		public override bool supportsMultipleWindows => true;
		public override Input input => _input;

		internal readonly Dictionary<IntPtr, SDL_GLContext> _glContexts = new Dictionary<IntPtr, SDL_GLContext>();
		...
		protected override void ApplicationStarted()
		{
			...
			for (int i = 0; i < numDisplays; i++)
				_monitors.Add(new SDL_Monitor(i));
		}
		...
		{
			return (window.implementation as SDL_Window)?._glContext ?? throw new Exception("Window is missing a GL Context");
		}
